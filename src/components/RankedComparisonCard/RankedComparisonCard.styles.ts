export const styles = {
  container: 'bg-white rounded-2xl shadow-lg border border-slate-200 p-4',
...
export const rankCardStyles = {
  container: 'bg-white rounded-2xl p-6 border border-slate-200 shadow-sm',
  ...
  iconWrapper: 'w-14 h-14 rounded-xl overflow-hidden shadow-sm bg-slate-50 flex-shrink-0',
  icon: 'w-full h-full object-contain p-1',
  info: 'flex-1 min-w-0',
  title: 'font-bold text-base text-slate-700',
  tier: 'text-sm font-bold text-slate-600',
